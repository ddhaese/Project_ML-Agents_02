...
public class Obelix : Agent
{
    ...
    private Boolean carriesMenhir = false;
    ...
    {
        if (collision.transform.CompareTag("Destination") & carriesMenhir)
        {
            AddReward(10);
            carriesMenhir = false;
        ...
        else if (collision.transform.CompareTag("Menhir") & !carriesMenhir)
        {
            AddReward(1);
